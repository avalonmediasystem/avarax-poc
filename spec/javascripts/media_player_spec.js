...
`)
  ...
  <track kind="subtitles" src="http://dlib.indiana.edu/iiif_av/lunchroom_manners/lunchroom_manners.vtt" srclang="en">
    ...
    it('can create the markup for the structure section of a manifest', () => {
        var mediaPlayer = Avalon.mediaPlayer({'manifest': manifest, 'target': 'media-player-target'})
      
        document.getElementById('media-player-target').innerHTML = mediaPlayer.renderStructure(manifest['structures'], [], '')
	expect(document.getElementById('media-player-target').innerHTML).toEqual(`<ul><li>Lunchroom Manners</li><ul><li><a href="http://dlib.indiana.edu/iiif_av/lunchroom_manners/canvas/1#t=0,157">Getting Ready for Lunch</a></li><ul><li><a href="http://dlib.indiana.edu/iiif_av/lunchroom_manners/canvas/1#t=0,157">Washing Hands</a></li><ul><li><a href="http://dlib.indiana.edu/iiif_av/lunchroom_manners/canvas/1#t=0,157">Using Soap</a></li></ul><ul><li><a href="http://dlib.indiana.edu/iiif_av/lunchroom_manners/canvas/1#t=160,165">Rinsing Well</a></li></ul></ul></ul><ul><li><a href="http://dlib.indiana.edu/iiif_av/lunchroom_manners/canvas/1#t=178,227">In the Lunchroom</a></li><ul><li><a href="http://dlib.indiana.edu/iiif_av/lunchroom_manners/canvas/1#t=178,227">At the Counter</a></li><ul><li><a href="http://dlib.indiana.edu/iiif_av/lunchroom_manners/canvas/1#t=178,227">Getting Tray</a></li></ul><ul><li><a href="http://dlib.indiana.edu/iiif_av/lunchroom_manners/canvas/1#t=245,258">Choosing Food</a></li></ul><ul><li><a href="http://dlib.indiana.edu/iiif_av/lunchroom_manners/canvas/1#t=288,301">There will be Cake</a></li></ul></ul><ul><li><a href="http://dlib.indiana.edu/iiif_av/lunchroom_manners/canvas/1#t=308,323">At the Table</a></li><ul><li><a href="http://dlib.indiana.edu/iiif_av/lunchroom_manners/canvas/1#t=308,323">Sitting Quietly</a></li></ul><ul><li><a href="http://dlib.indiana.edu/iiif_av/lunchroom_manners/canvas/1#t=333,362">Eating Neatly</a></li></ul></ul></ul><ul><li><a href="http://dlib.indiana.edu/iiif_av/lunchroom_manners/canvas/1#t=378,448">Leaving the Lunchroom</a></li><ul><li><a href="http://dlib.indiana.edu/iiif_av/lunchroom_manners/canvas/1#t=378,448">Cleaning Up</a></li></ul><ul><li><a href="http://dlib.indiana.edu/iiif_av/lunchroom_manners/canvas/1#t=492,511">Putting Things Away</a></li></ul></ul></ul>`)
    })
})

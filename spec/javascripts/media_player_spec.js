...
`)
    ...
    it('creates HTML5 video markup when given a IIIF-AV manifest', () => {
        ...
        expect(mediaPlayerMarkup).toEqual(`<div class="av-player"><div class="av-controls"><ul><li><a data-turbolinks="false" data-target="#" href="#t=0,157" class="media-structure-uri">Lunchroom Manners</a></li><ul class="canvas-range"><a data-target="#" data-turbolinks="false" class="canvas-url" href="#t=157,178">Getting Ready for Lunch</a><ul class="canvas-range"><a data-target="#" data-turbolinks="false" class="canvas-url" href="#t=157,178">Washing Hands</a><ul><li><a data-turbolinks="false" data-target="#" href="#t=157,160" class="media-structure-uri">Using Soap</a></li></ul><ul><li><a data-turbolinks="false" data-target="#" href="#t=165,178" class="media-structure-uri">Rinsing Well</a></li></ul></ul></ul><ul class="canvas-range"><a data-target="#" data-turbolinks="false" class="canvas-url" href="#t=227,378">In the Lunchroom</a><ul class="canvas-range"><a data-target="#" data-turbolinks="false" class="canvas-url" href="#t=227,308">At the Counter</a><ul><li><a data-turbolinks="false" data-target="#" href="#t=227,245" class="media-structure-uri">Getting Tray</a></li></ul><ul><li><a data-turbolinks="false" data-target="#" href="#t=258,288" class="media-structure-uri">Choosing Food</a></li></ul><ul><li><a data-turbolinks="false" data-target="#" href="#t=301,308" class="media-structure-uri">There will be Cake</a></li></ul></ul><ul class="canvas-range"><a data-target="#" data-turbolinks="false" class="canvas-url" href="#t=323,378">At the Table</a><ul><li><a data-turbolinks="false" data-target="#" href="#t=323,333" class="media-structure-uri">Sitting Quietly</a></li></ul><ul><li><a data-turbolinks="false" data-target="#" href="#t=362,378" class="media-structure-uri">Eating Neatly</a></li></ul></ul></ul><ul class="canvas-range"><a data-target="#" data-turbolinks="false" class="canvas-url" href="#t=448,527">Leaving the Lunchroom</a><ul><li><a data-turbolinks="false" data-target="#" href="#t=448,492" class="media-structure-uri">Cleaning Up</a></li></ul><ul><li><a data-turbolinks="false" data-target="#" href="#t=511,527" class="media-structure-uri">Putting Things Away</a></li></ul></ul></ul></div><div class="av-controls"><span class="mejs__offscreen">Video Player</span><div id="mep_0" class="mejs__container mejs__container-keyboard-inactive av-player-controls mejs__video" tabindex="0" role="application" aria-label="Video Player" style="width: 1280px; height: 937px;"><div class="mejs__inner"><div class="mejs__mediaelement"><mediaelementwrapper id="iiif-av-player"><video class="av-player-controls" id="iiif-av-player_html5" height="937" width="1280" data-mejsoptions="{&quot;pluginPath&quot;: &quot;&quot;, &quot;alwaysShowControls&quot;: &quot;true&quot;}" preload="none" src="http://dlib.indiana.edu/iiif_av/lunchroom_manners/medium/lunchroom_manners_512kb.mp4">
